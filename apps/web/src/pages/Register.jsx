    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-600 to-purple-700 items-center justify-center p-12">
        <div className="max-w-md animate-fadeIn">
          <h2 className="text-4xl font-bold text-white mb-4">Start building with Rversed</h2>
          <p className="text-brand-100 text-lg leading-relaxed mb-8">Create your account in seconds. No credit card required.</p>
          <div className="space-y-3">
            {['Accept payments globally', 'Real-time analytics dashboard', 'AI-powered fraud protection', 'Professional invoicing', 'Instant payouts'].map(f => (
              <div key={f} className="flex items-center gap-3 text-white">
                <svg className="w-5 h-5 text-brand-200" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white dark:bg-gray-900 transition-colors">
        <div className="w-full max-w-md animate-slideUp">
          ...
          <p className="mt-6 text-xs text-gray-400 dark:text-gray-500 text-center">By signing up, you agree to our Terms of Service and Privacy Policy.</p>
        </div>
      </div>
    </div>
  );
